...
- Adds a **45-degree rotated watermark** with the MMID to each page
...
│-- watersheet-XXXXXX.json       # Google Service Account credentials
...
```sh
pip install --upgrade google-auth google-auth-oauthlib google-auth-httplib2 googleapiclient pandas pillow pymupdf
```
...
```python
SERVICE_ACCOUNT_FILE = "D:\\WORK ACCOUNT\\WaterSheet_GCP\\watersheet-450610-b18de2cebbd9.json"
```
...
3. Apply a **semi-transparent 45-degree rotated watermark** with MMID.
